...
export type DaycarePlace = Schemas["DaycarePlace"];
export type DaycarePlaceInput = Schemas["DaycarePlaceInput"];
export type PickupPlan = Schemas["PickupPlan"];
export type PickupPlanDay = Schemas["PickupPlanDay"];
export type PickupOverride = Schemas["PickupOverride"];
export type DaycareToday = Schemas["DaycareToday"];
