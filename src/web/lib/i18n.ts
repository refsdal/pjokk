...
const nb: Record<string, string> = {
  ...
  "Add your baby to start tracking.":
    "Legg til babyen din for å komme i gang.",
  ...
  "Log a weight under More → Measurement":
    "Logg en vekt under Mer → Måling",
  ...
  "Notifications enabled on this device": "Varsler er slått på på denne enheten",
