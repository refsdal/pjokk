...
const nb: Record<string, string> = {
  ...
  // Core-log detail (#43): bottle contents, solids food/reaction, diaper
  // dry + colour/consistency, nap vs night. Capitalised = chips, lowercase
  // = timeline detail lines.
  Dry: "Tørr",
  dry: "tørr",
  "Dry diaper": "Tørr bleie",
  Formula: "Morsmelkerstatning",
  formula: "morsmelkerstatning",
  "Breast milk": "Morsmelk",
  "breast milk": "morsmelk",
  Mixed: "Blandet",
  mixed: "blandet",
  "Food (optional)": "Mat (valgfritt)",
  Reaction: "Reaksjon",
  reaction: "reaksjon",
  Colour: "Farge",
  Consistency: "Konsistens",
  "Add detail": "Legg til detaljer",
  Yellow: "Gul",
  yellow: "gul",
  Green: "Grønn",
  green: "grønn",
  ...
  // Shared nursing / pump timer (#44)
  Feeding: "Ammer",
  Pumping: "Pumper",
  Paused: "Pauset",
  Pause: "Pause",
  Resume: "Fortsett",
  "Discard timer": "Forkast tidtaker",
  "Timer started by": "Tidtaker startet av",
  "Could not discard the timer": "Kunne ikke forkaste tidtakeren",
  "A pump timer is running — stop it from Home.":
    "En pumpetidtaker kjører — stopp den fra Hjem.",
  timer: "tidtaker",
  pump: "pumping",
  Stop: "Stopp",
  ...
  Units: "Enheter",
  "Metric (ml, kg, cm, °C)": "Metrisk (ml, kg, cm, °C)",
  "Imperial (oz, lb, in, °F)": "Imperial (oz, lb, in, °F)",
  "Only how numbers are shown to you — everyone's entries are stored the same way.":
    "Bare hvordan tall vises for deg – alles oppføringer lagres likt.",
  "Always metric (ml, kg, cm, °C), whatever your display units.":
    "Alltid metrisk (ml, kg, cm, °C), uansett visningsenheter.",
  ...
  "A one-file summary for the helsestasjon or the doctor: sleep, intake, growth with percentiles, temperatures, medicines and vaccines. Built on this device.":
    "Ett dokument til helsestasjonen eller legen: søvn, inntak, vekst med persentiler, temperaturer, medisiner og vaksiner. Lages på denne enheten.",
  "Last 7 days": "Siste 7 dager",
  "Last 30 days": "Siste 30 dager",
  "Building…": "Lager…",
  "Download PDF report": "Last ned PDF-rapport",
  "Could not build the report": "Kunne ikke lage rapporten",
  "Nothing in this period": "Ingenting i perioden",
  Born: "Født",
  Period: "Periode",
  Generated: "Laget",
  "Averages per day": "Gjennomsnitt per dag",
  Measure: "Mål",
  Value: "Verdi",
  "Longest night stretch": "Lengste nattestrekk",
  Intake: "Inntak",
  "Day by day": "Dag for dag",
  Date: "Dato",
  "Growth (latest)": "Vekst (siste)",
  Percentile: "Persentil",
  "percentile (WHO)": "persentil (WHO)",
  Temperatures: "Temperaturer",
  When: "Når",
  fever: "feber",
  "Medicines given": "Medisiner gitt",
  "Programme age": "Programalder",
  Status: "Status",
  Given: "Gitt",
  Due: "Forfalt",
  Skipped: "Hoppet over",
  "Made with Pjokk": "Laget med Pjokk",
  "Imperial units": "Imperiale enheter",
  "Metric units": "Metriske enheter",
  ...
  "No reminders yet. Add one for a feed gap, a medicine or a fixed time.":
    "Ingen påminnelser ennå. Legg til en for et måltidsopphold, en medisin eller et fast tidspunkt.",
  Custom: "Egendefinert",
  "What to remind about": "Hva skal du minnes på",
  "Medicine name (optional)": "Medisinnavn (valgfritt)",
  "After a gap": "Etter et opphold",
  "At a time": "På et tidspunkt",
  "When nothing is logged for": "Når ingenting er logget på",
  At: "Kl.",
  Time: "Tid",
  "Every day": "Hver dag",
  Weekdays: "Hverdager",
  ...
  "Breast L": "Bryst V",
  "Breast R": "Bryst H",
  "No diaper logged yet": "Ingen bleie logget ennå",
  "Hold the name to leave kiosk": "Hold inne navnet for å forlate kiosk",
