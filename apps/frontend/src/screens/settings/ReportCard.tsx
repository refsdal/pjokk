...
// Settings → <baby> → PDF report (issue #53): the last week or month for
// the baby whose page this is, built in the browser (lib/report.ts).
export function ReportCard({ baby }: { baby: Baby }) {
    ...
    <Card className="space-y-3">
      ...
      >
        <span className="inline-flex items-center gap-1.5">
          ...
          {busy ? t("Building…") : `${t("Download PDF report")} · ${baby.name}`}
        </span>
      </Button>
    </Card>
  );
