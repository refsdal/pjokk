...
func TestAdminRoutesRequireSysadmin(t *testing.T) {
	...
	routes := []struct{ method, path string }{
		...
		{http.MethodGet, "/api/admin/backups/2026-08-31/families"},
		{http.MethodPost, "/api/admin/backups/2026-08-31/families/some-family/restore"},
	}
...
var reassignedUserReferences = map[string]bool{
	...
	"feed_log.logged_by_id":           true,
	"diaper_log.logged_by_id":         true,
	"medicine_log.logged_by_id":       true,
	"bath_log.logged_by_id":           true,
	"note_log.logged_by_id":           true,
	"milestone_log.logged_by_id":      true,
	"measurement_log.logged_by_id":    true,
	"pump_log.logged_by_id":           true,
	"play_log.logged_by_id":           true,
	"feed_timer.logged_by_id":         true,
	"vaccine_log.logged_by_id":        true,
