...
// a false negative. Deps.Pool is intentionally unread here.
...
// Readyz runs `SELECT 1` against the pool and reports 503 on failure.
// The failure is answered in the response body rather than
