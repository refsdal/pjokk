...
console.log(
  "landing: wrote dist/index.html, dist/nb/index.html, dist/{privacy,terms}/index.html, dist/nb/{privacy,terms}/index.html, dist/robots.txt, dist/og.png, dist/icon.svg, dist/icon-180.png" +
    (INDEXABLE
      ? ", dist/sitemap.xml"
