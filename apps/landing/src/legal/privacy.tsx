  ...
  return (
    <>
      ...
      <p>
        ...
        to restore the service after a failure, or to undo a deletion made by
        mistake — never one you asked for. For that purpose the operator can
        download a copy; every download is recorded in the audit trail, and a
        downloaded copy is kept inside the EU and deleted as soon as it has
        served its purpose.
      </p>
  ...
  return (
    <>
      ...
      <p>
        ...
        brukes utelukkende til å gjenopprette tjenesten etter feil, eller til å
        angre en sletting gjort ved en feil — aldri en du har bedt om. Til det
